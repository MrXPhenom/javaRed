...
public class MyCitiesGame {
    ...
    private static void gameLoop() {
        System.out.println("Введіть назву міста, щоб почати гру:");
        ...
        while (true){
            ...
            //Прервірка чи є місто, яке ввів користувач, у списку
            ...
            if(!isCorrectCity){
                System.out.println("Такого міста немає в базі. Спробуте знову.");
                continue;
            }
            //Перевірка, чи з правильної бувви починається слово
            if(lastComputerCity != null){
                ...
                if(Character.toLowerCase(lastComputerCityChar) != Character.toLowerCase(firstInputChar)){
                    System.out.println("Ви ввели міто з непровильною першою буквою. Повторіть спробу");
                    continue;
                }
            }
